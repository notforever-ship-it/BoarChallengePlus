...
BC.ITEMS = {
  ...
  { g = "top", key = "head", label = "Boars to level", on = true, tip = "The big line: how many boars to the next level, at your XP per boar." },
  ...
  { g = "num", c = "xp", key = "xpb", label = "XP per boar", on = true, tip = "What a boar gives on average this session, rested bonus included." },
  ...
  { g = "num", c = "time", key = "pace", label = "Time to level", on = true, tip = "How long the next level takes at your pace (the last 30 minutes)." },
