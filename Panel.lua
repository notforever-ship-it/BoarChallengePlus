...
local function Build()
  panel = CreateFrame("Frame", "BoarChallengePanel", UIParent)
...
local function BuildEdit()
  edit = CreateFrame("Frame", "BoarChallengeEdit", UIParent)
  edit:SetWidth(340)
  edit:SetHeight(290)
  ...
  edit:Hide()
  table.insert(UISpecialFrames, "BoarChallengeEdit")
  ...
  local close = CreateFrame("Button", "BoarChallengeEditClose", edit, "UIPanelCloseButton")
  ...
  for i = 1, table.getn(FIELDS) do
    ...
    local box = CreateFrame("EditBox", "BoarChallengeEdit" .. f.key, edit, "InputBoxTemplate")
    box:SetWidth(120)
    box:SetHeight(20)
  ...
  local save = CreateFrame("Button", "BoarChallengeEditSave", edit, "UIPanelButtonTemplate")
  save:SetWidth(100)
  save:SetHeight(22)
  ...
  local cancel = CreateFrame("Button", "BoarChallengeEditCancel", edit, "UIPanelButtonTemplate")
  cancel:SetWidth(80)
  cancel:SetHeight(22)
  ...
  local session = CreateFrame("Button", "BoarChallengeEditSession", edit, "UIPanelButtonTemplate")
  ...
  local reset = CreateFrame("Button", "BoarChallengeEditReset", edit, "UIPanelButtonTemplate")
  reset:SetWidth(110)
  reset:SetHeight(22)
